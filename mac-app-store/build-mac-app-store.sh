...
echo "  2) le bootstrap réseau runtime (StoryBox.QT / studio-pack-generator) n'a pas été supprimé du chantier ;"
echo "  3) l'accès sandbox à la boîte à histoires montée en volume amovible n'a pas encore été validé en conditions App Store."
echo ""
